<%@ Page Title="" Language="C#" MasterPageFile="~/admin/a-first.Master" AutoEventWireup="true" CodeBehind="MobileGameInput.aspx.cs" Inherits="Esra.WebUI.admin.MobileGameInput" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="">
        ...
        <div class="row js-show-and-edit-form" style="display: none;">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>فرم ورود اطلاعات<small>اطلاعات بازی های موبایلی</small>
                        </h2>
                            ...
                            <div id="step-1">
                                ...
                                <form class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <CKEditor:CKEditorControl ID="esra_summary" runat="server" ClientIDMode="Static" />
                                        </div>
                                    </div>
        ...
        <div class="row js-load-data-for-edit" style="display: none;">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>فرم ویرایش اطلاعات<small>اطلاعات بازی های موبایلی</small>
                        </h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a class="collapse-link">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function addGameDetails() {
                ...
                esraSummary = CKEDITOR.instances['esra_summary'].getData().replace(/<[^>]*>/g, "");
            ...
            $(".buttonFinish,#EditMobileGameInput").on("click", function () {
                ...
                $.ajax({
                    ...
                    success: function (reponse) {
                        ...
                        window.location.href = "MobileGameInput.aspx";
                    },
            ...
            if (getParameterByName("mode") == "android") {
                hidTag();

                $('#cpBodyMiddle_platform_ver option[value=' + 8 + ']').prop('selected', 'selected');
                //$('#cpBodyMiddle_platform_ver').prop('disabled', true);

                $('#cpBodyMiddle_source_type option[value=' + + ']').prop('selected', 'selected');
            }
