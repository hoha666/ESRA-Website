<%@ Page Title="" Language="C#" MasterPageFile="~/admin/a-first.Master" AutoEventWireup="true" CodeBehind="GameIntroInputBpms.aspx.cs" Inherits="Esra.WebUI.admin.GameIntroInputBpms" ValidateRequest="false" EnableEventValidation="false" %>
                        ...
                        <div class="x_content ui form">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-2">
                                    در معرفی بازی نمایش داده شود؟
                                </label>
                                <label class="chbox col-md-12 col-sm-12 col-xs-12">
                                    <input type="checkbox" class="js-switch" id="chbShowInEsraWebsite" runat="server" />
                                </label>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <asp:ListBox Rows="5" ID="platforms" runat="server" SelectionMode="Single" CssClass="select2_multiple form-control"></asp:ListBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 field">
                                    ...
                                    <CKEditor:CKEditorControl ID="parentRecomandation" runat="server" ClientIDMode="Static" />
                            ...
                            <asp:TextBox runat="server" ID="txtPicCover" Style="display: none;" ClientIDMode="Static"></asp:TextBox>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cpBodyBottom" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $(".form").form();
            var areas = Array('intro_short', 'intro_gameplay', 'parentRecomandation');
        ...
        function setFileName() {
            $(document).ready(function () {
                ...
                $('#txtPicCover').val($('#cpBodyMiddle_pnl_OldPic').find('.isCover').parent().find('span:nth(1)').html());
